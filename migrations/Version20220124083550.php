 ...
 */
final class Version20220124083550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, thread_id INT NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, up_vote INT DEFAULT NULL, down_vote INT NOT NULL, INDEX IDX_5A8A6C8DE2904019 (thread_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE thread (id INT AUTO_INCREMENT NOT NULL, sub_category_id INT NOT NULL, subject VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_31204C83F7BFE87C (sub_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
